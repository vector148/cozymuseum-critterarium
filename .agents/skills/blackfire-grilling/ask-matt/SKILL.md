...
This is an **Operations-only engineering workflow router** under ADR-0018. It routes an Operations technical handoff through Operations methods; it is not a shared company planning skill and does not replace another department's Planning mega-skill.
