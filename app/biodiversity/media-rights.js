...
export const RIGHTS_FREE_LICENSES = Object.freeze(["CC0", "Public Domain"]);
...
export function imageRightsFailures(row = {}) {
  ...
  if (!isRightsFreeLicense(row.imageLicense)) failures.push("image license is not CC0 or Public Domain");
