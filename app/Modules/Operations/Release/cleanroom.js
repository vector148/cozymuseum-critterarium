...
const PLATFORM_SURFACE_PATTERN = new RegExp(
  "\\\\b(?:cura" + "tale|supa" + "base|gtag|googletagmanager|vercel|foyer|greathall)\\\\b|reading[-_ ]room",
  "i"
);
...
/**
 * Inspect a release tree for cleanroom violations.
 * Returns { ok: boolean, violations: Array<{ path, reason }> }.
 */
